...
static esp_ble_mesh_model_t my_model[] = {
    ESP_BLE_MESH_MODEL_GEN_ONOFF_CLI(&onoff_cli_pub_1, &onoff_client_1),
};


static esp_ble_mesh_elem_t elements[] = {
    ESP_BLE_MESH_ELEMENT(0, root_models, ESP_BLE_MESH_MODEL_NONE),
    ESP_BLE_MESH_ELEMENT(0, my_model, ESP_BLE_MESH_MODEL_NONE),
};
...
void k_example_ble_mesh_send_gen_onoff_set(void)
{
